...
export declare var ApprovalList: StaticListSchema;
export declare var ApprovalRulesList: StaticListSchema;
export declare var ApprovalRulesNotSatisfiedList: number;
export declare var ApprovalRulesSatisfiedList: number;
export declare var ApprovalRuleTemplateNameList: number;
export declare var BatchAssociateApprovalRuleTemplateWithRepositoriesErrorsList: StaticListSchema;
export declare var BatchDescribeMergeConflictsErrors: StaticListSchema;
export declare var BatchDisassociateApprovalRuleTemplateFromRepositoriesErrorsList: StaticListSchema;
export declare var BatchGetCommitsErrorsList: StaticListSchema;
export declare var BatchGetRepositoriesErrorsList: StaticListSchema;
export declare var BranchNameList: number;
export declare var CallerReactions: number;
export declare var Comments: StaticListSchema;
export declare var CommentsForComparedCommitData: StaticListSchema;
export declare var CommentsForPullRequestData: StaticListSchema;
export declare var CommitIdsInputList: number;
export declare var CommitObjectsList: StaticListSchema;
export declare var ConflictMetadataList: StaticListSchema;
export declare var Conflicts: StaticListSchema;
export declare var DeleteFileEntries: StaticListSchema;
export declare var DifferenceList: StaticListSchema;
export declare var FileList: StaticListSchema;
export declare var FilePaths: number;
export declare var FilesMetadata: StaticListSchema;
export declare var FolderList: StaticListSchema;
export declare var MergeHunks: StaticListSchema;
export declare var MergeOptions: number;
export declare var ParentList: number;
export declare var PullRequestEventList: StaticListSchema;
export declare var PullRequestIdList: number;
export declare var PullRequestTargetList: StaticListSchema;
export declare var PutFileEntries: StaticListSchema;
export declare var ReactionsForCommentList: StaticListSchema;
export declare var ReactionUsersList: number;
export declare var ReplaceContentEntries: StaticListSchema;
export declare var RepositoryMetadataList: StaticListSchema;
export declare var RepositoryNameIdPairList: StaticListSchema;
export declare var RepositoryNameList: number;
export declare var RepositoryNotFoundList: number;
export declare var RepositoryTriggerEventList: number;
export declare var RepositoryTriggerExecutionFailureList: StaticListSchema;
export declare var RepositoryTriggerNameList: number;
export declare var RepositoryTriggersList: StaticListSchema;
export declare var RevisionChildren: number;
export declare var RevisionDag: StaticListSchema;
export declare var SetFileModeEntries: StaticListSchema;
export declare var SubModuleList: StaticListSchema;
export declare var SymbolicLinkList: StaticListSchema;
export declare var TagKeysList: number;
export declare var TargetList: StaticListSchema;
export declare var ReactionCountsMap: number;
